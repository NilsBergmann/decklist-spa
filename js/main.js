...
import './render/m15.js?v=7';          // registers m15 renderer
import './render/m15-2col.js?v=7';     // registers m15 2-column renderer
import './render/art-bg.js?v=6';       // registers art-background renderer
