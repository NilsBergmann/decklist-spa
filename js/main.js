...
import './render/m15.js?v=9';          // registers m15 renderer
import './render/m15-2col.js?v=9';     // registers m15 2-column renderer
import './render/art-bg.js?v=8';       // registers art-background renderer
